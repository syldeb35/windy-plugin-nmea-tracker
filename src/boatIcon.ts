export function createRotatingBoatIcon(courseOverGround: number, opacity?: number): L.DivIcon {
    ...
    return L.divIcon({
        className: '',
        html: `
            <div class="rotatable" data-heading="${courseOverGround}" style="transform: rotateZ(${courseOverGround}deg); transform-origin: 12px 12px;">
