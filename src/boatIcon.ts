...
export function createRotatingBoatIcon(head: number, opacity: number = 0.846008, scale: number = 1.0): any {
    ...
    return L.divIcon({
        className: '',
        html: `
            <div class="rotatable" data-heading="${head}" style="transform: rotateZ(${head}deg); transform-origin: 50% 50%;">
                <svg xmlns="http://www.w3.org/2000/svg" width="${scaledSize}" height="${scaledSize}" viewBox="0 0 14 14">
